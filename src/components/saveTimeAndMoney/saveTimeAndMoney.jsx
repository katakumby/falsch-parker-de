...
export const SaveTimeAndMoney = () => {
  ...
  return (
    <div className='relative mt-5 flex gap-5 text-dark max-lg:text-[34px] max-md:text-[34px] max-sm:flex-col max-sm:items-center lg:text-[53px] xl:text-[64px]'>
      <div className='relative h-full w-1/2 overflow-hidden rounded-card max-sm:h-[343px] max-sm:w-[343px]'>
        <div className='absolute w-full p-[20px] text-center  max-sm:p-[25px] max-sm:pt-[35px] xl:p-[60px]'>
          <span>Kosten</span>
          <br />
      ...
      <div className='relative h-full w-1/2 overflow-hidden rounded-bl-card rounded-tl-card rounded-tr-card max-sm:h-[343px] max-sm:w-[343px]'>
        <div className='absolute bottom-[35px] w-full p-[20px] text-center max-lg:p-[20px]  max-sm:p-[25px] xl:p-[60px]'>
